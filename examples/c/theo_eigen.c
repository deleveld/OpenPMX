...
{
	const double* theta = _advanstate->current.popparam->theta;
	const double* eta = _advanstate->current.popparam->eta;
	...
	pmx_advan_state_init(_advanstate, 0, 320);
